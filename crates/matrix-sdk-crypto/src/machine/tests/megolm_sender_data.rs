...
/// it with another [`OlmMachine`], *without* sending th MSC4147 sender data.
///
/// # Arguments
///
...
async fn create_and_share_session_without_sender_data(
    ...
    // TODO: save the session to the store? See
    //   `GroupSessionManager::share_room_key` for inspiration on how to do
    //   that.
...
async fn get_inbound_group_session_or_assert(
    machine: &OlmMachine,
